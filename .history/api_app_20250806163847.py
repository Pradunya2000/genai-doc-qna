...
async def clear_uploaded_files():
    ...
    # Optional: Clear ChromaDB folder if you want to reset the vectorstore
    chroma_folder = "chroma_db"  # Change this if your vectorstore folder is named differently
    if os.path.exists(chroma_folder):
        shutil.rmtree(chroma_folder)
        os.makedirs(chroma_folder, exist_ok=True)

    return {"message": "✅ All uploaded files and ChromaDB (if any) have been cleared."}
