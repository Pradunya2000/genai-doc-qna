...
async def clear_uploaded_files():
    try:
        ...
        # Optional: Clear ChromaDB folder
        chroma_folder = "chroma_db"  # Update this to your actual folder if different
        ...
        return JSONResponse(
            status_code=200,
            content={"message": "✅ All uploaded files and ChromaDB (if any) have been cleared."}
        )
