...
async def ask_questions(req: QuestionRequest, source_file: Optional[str] = Query(None)):
    ...
    for q in req.questions:
        ...
        # ✅ If question is about document summary, skip straight to summarization
        if "what are the documents about" in q_lower or "summarize" in q_lower:
            print("📝 Direct summarization triggered...")
            ...
            llm = ChatOpenAI(
                ...
                openai_api_base=os.getenv("OPENAI_API_BASE", "https://api.a4f.co/v1"),
            ...
            # ✅ Flexible vague answer check
            if any(phrase in answer_text for phrase in ["i don't know", "i dont know", "unknown", "not sure"]) or not answer_text.strip():
