...
with tabs[0]:
    ...
    def remove_file_slot(index):
        if "file_upload_count" in st.session_state and st.session_state.file_upload_count > 1:
            st.session_state.file_upload_count -= 1
            if "uploaded_files" in st.session_state and index < len(st.session_state.uploaded_files):
