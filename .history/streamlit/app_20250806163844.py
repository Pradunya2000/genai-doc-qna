    ...
    if res.status_code == 200:
        ...
        if not files:
            ...
            if st.button("🗑️ Clear All Uploaded Files"):
                confirm = st.warning("Are you sure you want to delete all files?", icon="⚠️")
                if st.confirm("This will remove all documents and embeddings. Are you sure?", type="warning"):
