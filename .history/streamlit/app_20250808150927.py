...
def clear_all_data():
    # ... (this function remains the same, but remember to use st.rerun() here as well) ...
def ask_questions(questions, selected_file):
...
with tab1:
    ...
    st.markdown("Upload multiple files to add them to the knowledge base.")
    ...
    with col2:
        st.markdown("*Click this button to process the selected files.*")
