...
# ✅ Request model: Always expect a list of questions
...
# ✅ Ask Endpoint (with optional source file filter)
@app.post("/ask/")
...
# ✅ List uploaded files (for metadata)
@app.get("/files/")
async def list_uploaded_files():
    return get_all_metadata()

# ✅ Define router for clearing files
file_router = APIRouter()
UPLOAD_DIR = Path("docs")

@file_router.delete("/clear-files")
...
# ✅ Include the file_router in the app
